...
At the Terminal (on a Mac), type "which python"  (i.e.: $ which python) (which -a python can be used to get a list of the different versions of python available to use)
